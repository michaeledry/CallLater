    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_SIGNIN_SUCCESS:
                ...
                Intent intent = new Intent(getApplication(),SetTime.class);
        ...
        if (user == null) {
            ...
            mStatusText.setText(R.string.sign_in);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_start_verification:
                ...
                startPhoneNumberVerification("+972" + mPhoneNumberField.getText().toString().substring(1));
                break;
